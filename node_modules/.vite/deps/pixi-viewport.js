...
var M = (c, r, t) => r in c ? S(c, r, { enumerable: true, configurable: true, writable: true, value: t }) : c[r] = t;
var o = (c, r, t) => (M(c, typeof r != "symbol" ? r + "" : r, t), t);
var f = class {
  constructor(r) {
    o(this, "parent");
    o(this, "paused");
    this.parent = r, this.paused = false;
  }
  destroy() {
  }
  down(r) {
  ...
  update(t) {
    ...
    if (this.time >= this.options.time) {
      ...
      if (this.width === null ? this.parent.scale.x = this.parent.scale.y : this.height === null && (this.parent.scale.y = this.parent.scale.x), !this.keepCenter) {
        const n = this.startX, s = this.startY, h = this.deltaX, a = this.deltaY, p = new Point(this.parent.x, this.parent.y);
...
var X = class extends f {
  ...
  bounce() {
    ...
    if (this.paused)
      return;
    let t, i = this.parent.plugins.get("decelerate", true);
    ...
    const e = this.parent.plugins.get("drag", true) || {}, n = this.parent.plugins.get("pinch", true) || {};
...
var A = class extends f {
  ...
  update() {
    if (this.paused || this.parent.x === this.last.x && this.parent.y === this.last.y && this.parent.scale.x === this.last.scaleX && this.parent.scale.y === this.last.scaleY)
      return;
    const t = new Point(this.parent.x, this.parent.y), i = this.parent.plugins.decelerate || {};
    if (this.options.left !== null || this.options.right !== null) {
      let e = false;
      if (!this.noUnderflow && this.parent.screenWorldWidth < this.parent.screenWidth)
        switch (this.underflowX) {
          case -1:
            this.parent.x !== 0 && (this.parent.x = 0, e = true);
            break;
          case 1:
            this.parent.x !== this.parent.screenWidth - this.parent.screenWorldWidth && (this.parent.x = this.parent.screenWidth - this.parent.screenWorldWidth, e = true);
            break;
          default:
            this.parent.x !== (this.parent.screenWidth - this.parent.screenWorldWidth) / 2 && (this.parent.x = (this.parent.screenWidth - this.parent.screenWorldWidth) / 2, e = true);
        }
      else
        this.options.left !== null && this.parent.left < (this.options.left === true ? 0 : this.options.left) && (this.parent.x = -(this.options.left === true ? 0 : this.options.left) * this.parent.scale.x, i.x = 0, e = true), this.options.right !== null && this.parent.right > (this.options.right === true ? this.parent.worldWidth : this.options.right) && (this.parent.x = -(this.options.right === true ? this.parent.worldWidth : this.options.right) * this.parent.scale.x + this.parent.screenWidth, i.x = 0, e = true);
    ...
    if (this.options.top !== null || this.options.bottom !== null) {
      ...
      if (!this.noUnderflow && this.parent.screenWorldHeight < this.parent.screenHeight)
        switch (this.underflowY) {
          case -1:
            this.parent.y !== 0 && (this.parent.y = 0, e = true);
            break;
          case 1:
            this.parent.y !== this.parent.screenHeight - this.parent.screenWorldHeight && (this.parent.y = this.parent.screenHeight - this.parent.screenWorldHeight, e = true);
            break;
          default:
            this.parent.y !== (this.parent.screenHeight - this.parent.screenWorldHeight) / 2 && (this.parent.y = (this.parent.screenHeight - this.parent.screenWorldHeight) / 2, e = true);
        }
      else
        this.options.top !== null && this.parent.top < (this.options.top === true ? 0 : this.options.top) && (this.parent.y = -(this.options.top === true ? 0 : this.options.top) * this.parent.scale.y, i.y = 0, e = true), this.options.bottom !== null && this.parent.bottom > (this.options.bottom === true ? this.parent.worldHeight : this.options.bottom) && (this.parent.y = -(this.options.bottom === true ? this.parent.worldHeight : this.options.bottom) * this.parent.scale.y + this.parent.screenHeight, i.y = 0, e = true);
    ...
    if (!this.paused) {
      if (this.options.minWidth || this.options.minHeight || this.options.maxWidth || this.options.maxHeight) {
        ...
        if (this.options.minWidth !== null && t < this.options.minWidth) {
          ...
          this.parent.fitWidth(this.options.minWidth, false, false, true), this.parent.scale.y *= this.parent.scale.x / e, t = this.parent.worldScreenWidth, i = this.parent.worldScreenHeight, this.parent.emit("zoomed", { viewport: this.parent, type: "clamp-zoom" });
        }
        if (this.options.maxWidth !== null && t > this.options.maxWidth) {
          const e = this.parent.scale.x;
          this.parent.fitWidth(this.options.maxWidth, false, false, true), this.parent.scale.y *= this.parent.scale.x / e, t = this.parent.worldScreenWidth, i = this.parent.worldScreenHeight, this.parent.emit("zoomed", { viewport: this.parent, type: "clamp-zoom" });
        }
        if (this.options.minHeight !== null && i < this.options.minHeight) {
          const e = this.parent.scale.y;
          this.parent.fitHeight(this.options.minHeight, false, false, true), this.parent.scale.x *= this.parent.scale.y / e, t = this.parent.worldScreenWidth, i = this.parent.worldScreenHeight, this.parent.emit("zoomed", { viewport: this.parent, type: "clamp-zoom" });
        }
        if (this.options.maxHeight !== null && i > this.options.maxHeight) {
          const e = this.parent.scale.y;
          this.parent.fitHeight(this.options.maxHeight, false, false, true), this.parent.scale.x *= this.parent.scale.y / e, this.parent.emit("zoomed", { viewport: this.parent, type: "clamp-zoom" });
        }
...
var E = class extends f {
  constructor(t, i = {}) {
    ...
    this.options = Object.assign({}, D, i), this.saved = [], this.timeSinceRelease = 0, this.reset(), this.parent.on("moved", (e) => this.handleMoved(e));
  }
  down() {
  ...
  update(t) {
    ...
    if (this.x) {
      ...
      this.parent.x += this.x * g / h * (Math.pow(s, n / g) - Math.pow(s, e / g)), this.x *= Math.pow(this.percentChangeX, t / g);
    }
    if (this.y) {
      const s = this.percentChangeY, h = Math.log(s);
      this.parent.y += this.y * g / h * (Math.pow(s, n / g) - Math.pow(s, e / g)), this.y *= Math.pow(this.percentChangeY, t / g);
    }
...
var U = class extends f {
  ...
  handleKeyPresses(t) {
    const i = (n) => {
      t.includes(n.code) && (this.keyIsPressed = true);
    }, e = (n) => {
      t.includes(n.code) && (this.keyIsPressed = false);
    };
  ...
  checkButtons(t) {
    ...
    return !!((e === 1 || e > 1 && !this.parent.plugins.get("pinch", true)) && (!i || this.mouse[t.button]));
  }
  checkKeyPress(t) {
  ...
  move(t) {
    ...
    if (this.last && this.current === t.data.pointerId) {
      ...
      if (n === 1 || n > 1 && !this.parent.plugins.get("pinch", true)) {
  ...
  up(t) {
    ...
    if (i.length === 1) {
      const e = i[0];
      return e.last && (this.last = { x: e.last.x, y: e.last.y }, this.current = e.id), this.moved = false, true;
    } else if (this.last && this.moved) {
      const e = new Point(this.last.x, this.last.y);
      ...
      if (this.options.speed)
        if (this.options.acceleration) {
          ...
          if (p) {
            ...
            const d = Math.cos(a) * this.velocity.x, m = Math.sin(a) * this.velocity.y, y = Math.abs(d) > Math.abs(s) ? e : i.x + d, x = Math.abs(m) > Math.abs(h) ? n : i.y + m;
            this.parent.moveCenter(y, x), this.parent.emit("moved", { viewport: this.parent, type: "follow" });
          }
        } else {
          const a = Math.atan2(n - i.y, e - i.x), p = Math.cos(a) * this.options.speed, l = Math.sin(a) * this.options.speed, d = Math.abs(p) > Math.abs(s) ? e : i.x + p, m = Math.abs(l) > Math.abs(h) ? n : i.y + l;
          this.parent.moveCenter(d, m), this.parent.emit("moved", { viewport: this.parent, type: "follow" });
        }
      else
  ...
  move(t) {
    ...
    if (n.length >= 2) {
      ...
      if (s.id === t.pointerId ? s.last = { x: i, y: e, data: t } : h.id === t.pointerId && (h.last = { x: i, y: e, data: t }), a) {
        ...
        d = d === 0 ? d = 1e-10 : d;
        const m = (1 - a / d) * this.options.percent * (this.isAxisX() ? this.parent.scale.x : this.parent.scale.y);
        this.isAxisX() && (this.parent.scale.x += m), this.isAxisY() && (this.parent.scale.y += m), this.parent.emit("zoomed", { viewport: this.parent, type: "pinch", center: l });
        const y = this.parent.plugins.get("clamp-zoom", true);
        ...
        !this.options.noDrag && this.lastCenter && (this.parent.x += (l.x - this.lastCenter.x) * this.options.factor, this.parent.y += (l.y - this.lastCenter.y) * this.options.factor, this.parent.emit("moved", { viewport: this.parent, type: "pinch" })), this.lastCenter = l, this.moved = true;
      } else
...
var G = class extends f {
  constructor(t, i = {}) {
    ...
    o(this, "yIndependent");
    o(this, "snapping");
    this.options = Object.assign({}, K, i), this.ease = W(this.options.ease), this.xIndependent = false, this.yIndependent = false, this.xScale = 0, this.yScale = 0, this.options.width > 0 && (this.xScale = t.screenWidth / this.options.width, this.xIndependent = true), this.options.height > 0 && (this.yScale = t.screenHeight / this.options.height, this.yIndependent = true), this.xScale = this.xIndependent ? this.xScale : this.yScale, this.yScale = this.yIndependent ? this.yScale : this.xScale, this.options.time === 0 ? (t.container.scale.x = this.xScale, t.container.scale.y = this.yScale, this.options.removeOnComplete && this.parent.plugins.remove("snap-zoom")) : i.forceStart && this.createSnapping();
  }
  createSnapping() {
  ...
  update(t) {
    ...
    if (!this.options.center && !this.options.noMove && (i = this.parent.center), !this.snapping)
      ...
      const n = this.parent.plugins.get("clamp-zoom", true);
...
var J = class extends f {
  constructor(t, i = {}) {
    ...
    o(this, "keyIsPressed");
    this.options = Object.assign({}, Q, i), this.keyIsPressed = false, this.options.keyToPress && this.handleKeyPresses(this.options.keyToPress);
  }
  handleKeyPresses(t) {
  ...
  wheel(t) {
    ...
    if (t.ctrlKey && this.options.trackpadPinch)
      ...
      if (this.options.smooth) {
        ...
        const a = this.parent.plugins.get("clamp-zoom", true);
...
var $ = class {
  ...
  addListeners() {
    this.viewport.interactive = true, this.viewport.forceHitArea || (this.viewport.hitArea = new Rectangle(0, 0, this.viewport.worldWidth, this.viewport.worldHeight)), this.viewport.on("pointerdown", this.down, this), this.viewport.options.allowPreserveDragOutside ? this.viewport.on("globalpointermove", this.move, this) : this.viewport.on("pointermove", this.move, this), this.viewport.on("pointerup", this.up, this), this.viewport.on("pointerupoutside", this.up, this), this.viewport.on("pointercancel", this.up, this), this.viewport.options.allowPreserveDragOutside || this.viewport.on("pointerleave", this.up, this), this.wheelFunction = (r) => this.handleWheel(r), this.viewport.options.events.domElement.addEventListener(
      "wheel",
      this.wheelFunction,
  ...
  down(r) {
    if (this.viewport.pause || !this.viewport.worldVisible)
      return;
    if (r.pointerType === "mouse" ? this.isMouseDown = true : this.get(r.pointerId) || this.touches.push({ id: r.pointerId, last: null }), this.count() === 1) {
      this.last = r.global.clone();
      const i = this.viewport.plugins.get("decelerate", true), e = this.viewport.plugins.get("bounce", true);
      (!i || !i.isActive()) && (!e || !e.isActive()) ? this.clickedAvailable = true : this.clickedAvailable = false;
    } else
  ...
  move(r) {
    ...
    if (this.clickedAvailable && this.last) {
      ...
      (this.checkThreshold(i) || this.checkThreshold(e)) && (this.clickedAvailable = false);
    }
  ...
  up(r) {
    if (this.viewport.pause || !this.viewport.worldVisible)
      return;
    r.pointerType === "mouse" && (this.isMouseDown = false), r.pointerType !== "mouse" && this.remove(r.pointerId);
    ...
    }), this.clickedAvailable = false), t && this.viewport.options.stopPropagation && r.stopPropagation();
  }
...
var ht = class extends Container {
  constructor(t) {
    ...
    o(this, "_worldWidth");
    o(this, "_worldHeight");
    o(this, "_disableOnContextMenu", (t2) => t2.preventDefault());
    this.options = {
      ...et,
      ...t
  ...
  resize(t = window.innerWidth, i = window.innerHeight, e, n) {
    this.screenWidth = t, this.screenHeight = i, typeof e < "u" && (this._worldWidth = e), typeof n < "u" && (this._worldHeight = n), this.plugins.resize(), this.dirty = true;
  }
  get worldWidth() {
  ...
  toWorld(t, i) {
    return arguments.length === 2 ? this.toLocal(new Point(t, i)) : this.toLocal(t);
  }
  toScreen(t, i) {
    return arguments.length === 2 ? this.toGlobal(new Point(t, i)) : this.toGlobal(t);
  }
  ...
  moveCenter(...t) {
    ...
    return (this.x !== n || this.y !== s) && (this.position.set(n, s), this.plugins.reset(), this.dirty = true), this;
  }
  get corner() {
  ...
  moveCorner(...t) {
    let i, e;
    return t.length === 1 ? (i = -t[0].x * this.scale.x, e = -t[0].y * this.scale.y) : (i = -t[0] * this.scale.x, e = -t[1] * this.scale.y), (i !== this.x || e !== this.y) && (this.position.set(i, e), this.plugins.reset(), this.dirty = true), this;
  }
  ...
  fitWidth(t = this.worldWidth, i, e = true, n) {
    let s;
  ...
  fitHeight(t = this.worldHeight, i, e = true, n) {
    let s;
  ...
  fitWorld(t) {
    ...
    const e = this.plugins.get("clamp-zoom", true);
  ...
  ensureVisible(t, i, e, n, s) {
    s && (e > this.worldScreenWidth || n > this.worldScreenHeight) && (this.fit(true, e, n), this.emit("zoomed", { viewport: this, type: "ensureVisible" }));
    let h = false;
    t < this.left ? (this.left = t, h = true) : t + e > this.right && (this.right = t + e, h = true), i < this.top ? (this.top = i, h = true) : i + n > this.bottom && (this.bottom = i + n, h = true), h && this.emit("moved", { viewport: this, type: "ensureVisible" });
  }
};
export {
  k as Animate,
